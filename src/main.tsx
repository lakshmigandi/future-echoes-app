  import React, { useState, useEffect } from 'react';
    ...
    const App: React.FC = () => {
      ...
      const API_KEY = 'sk_f539e12593fe8818b54345d8d1c15148bc008fd09ea8ec7f'; // YOUR ElevenLabs API key
      // --- END WORKAROUND ---

      const VOICE_ID = 'EXAVITQu4vr4xnSDxMaL'; // Sarah's voice ID (confirmed available)
